  ...
  properties: {
    ...
    siteConfig: {
      appSettings: [
        ...
        {
          name: 'SQLConnection'
          value: 'Server=tcp:sqlexample01${environment().suffixes.sqlServerHostname},1433;Initial Catalog=SQLExample;Persist Security Info=False;User ID=aperezv01;Password=Absalon01%;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;'
        }
        {
